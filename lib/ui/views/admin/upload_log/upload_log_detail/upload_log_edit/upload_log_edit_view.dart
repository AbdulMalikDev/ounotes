    ...
    return ViewModelBuilder<UploadLogEditViewModel>.reactive(
      ...
      onModelReady: (model) async {
        ...
        switch (model.documentEnum) {
          case Document.Notes:
            authorController =
                TextEditingController(text: (model.doc as Note).author);
            break;
          case Document.Syllabus:
            ...
            yearController =
                TextEditingController(text: (model.doc as Syllabus).year);
            break;
          case Document.QuestionPapers:
            ...
            print(model.br);
            yearController =
                TextEditingController(text: (model.doc as QuestionPaper).year);
            break;
          case Document.Links:
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                                ...
                                Flexible(
                                  child: Container(
                                    child: DropdownButton(
                                      ...
                                      onChanged: (_) {
                                        model.changedDropDownItemOfdocumentType(
                                            _);
                                        setState(() {});
                                      },
                          ...
                          if (model.documentEnum == Document.QuestionPapers ||
                              model.documentEnum == Document.Syllabus)
                            Container(
                              margin:
                                  const EdgeInsets.symmetric(horizontal: 10),
                              child: TextFormFieldView(
