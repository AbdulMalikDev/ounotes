...
class OnboardingService{
  ...
  static const List<Map<String, String>> uploadPrompts = [
    {
      'Don\'t forget to Upload Notes 📗, Question Papers📝, Syllabus📜 or YouTube Channel links🔗 which you have found helpful':
          "Finish"
    },
    {"Upload some Notes na ! 🥺": "No i won't 😠"},
    {"Notes upload karo na bhayya please": "Nai hota ustaad dam nakko karo"},
    {
      "You have a chance to help 10,000+ students 📝 worldwide by uploading the best notes you have !":
