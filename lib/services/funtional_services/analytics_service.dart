...
class AnalyticsService {
  ...
  sendNotification(
    ...
    //   'app_id':
    //       '${_remoteConfigService.remoteConfig.getString('ONESIGNAL_APP_ID')}',
    //   "contents": {"en": message ?? "No Message"},
    //   "headings": {"en": title ?? "Test"},
    //   "channel_for_external_user_ids": "push",
    //   "include_external_user_ids": ["$id"]
    // });
    // http.Response response = await http.post(
    //   //TODO changed this from url --> Uri.parse(url) testing required
    //   Uri.parse(url),
    //   headers: {
    //     "Content-Type": "application/json",
    //     "Authorization":
    //         "Basic ${_remoteConfigService.remoteConfig.getString('ONESIGNAL_API_KEY')}"
    //   },
    //   body: body,
    // );
