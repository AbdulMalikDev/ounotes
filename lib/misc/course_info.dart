...
class CourseInfo {
  ...
  static List<Subject> aallsubjects = [
    ...
    Subject(6, "INDIAN CONSTITUTION",branchToSem: {'ECE':['1','3'],"MECH":["1",'3'],"IT":["1",'3'],"PE":["1",'3'],"AE":["1",'3'],"CSE":['2','4'],"CIVIL":['2','4'],"EEE":['2','4'],"EIE":['2','4']}),
    Subject(7, "PHYSICS", branchToSem: {'ECE':['1'],"MECH":['1'],"IT":["1"],"PE":["1"],"AE":["1"],"CSE":['2'],"CIVIL":['2'],"EEE":['2'],"EIE":['2']}),
    Subject(
        8, "BASIC ELECTRICAL ENGINEERING",branchToSem: {'ECE':['1'],"MECH":["1"],"IT":["1"],"PE":["1"],"AE":["1"],"CSE":['2'],"CIVIL":['2'],"EEE":['2'],"EIE":['2']}),
    ...
    //MECH
    //* VERIFIED
    Subject(85, "Automata Languages & Computation",branchToSem: {"MECH":["5"],"AE":["5"],"PE":["5"],"CSE":["5"]}),
    //* VERIFIED
    Subject(86, "MACHINE DESIGN",branchToSem: {"MECH":["6"],"PE":["6"]}),
    //* VERIFIED
    Subject(87, "HEAT TRANSFER",branchToSem: {"MECH":["5"],"AE":["5"],}),
    //*VERIFIED
    Subject(89, "CAD/CAM",branchToSem: {"MECH":["6"]},type: SubjectType.Elective),
    //CSE
    //!DELETE [EXTRA]
    ...
    //* VERIFIED
    Subject(95, "ARTIFICIAL INTELLIGENCE",branchToSem: {"CSE":["5"],"IT":["5"]},type: SubjectType.Elective),
    //IT
    //! DELETE [EXTRA]
    ...
    //* VERIFIED
    Subject(122, "AUTOMOBILE ENGINEERING",branchToSem: {"MECH":["6"],"PE":["6"]},type: SubjectType.Elective),
    //CSE
    //*VERIFIED
    ...
    //CIVIL
    //*VERIFIED
    Subject(135, "STEEL STRUCTURES",branchToSem: {"CIVIL":["6"]},type: SubjectType.Elective),
    //! DELETE
    ...
    //!NEW ADDED SUBJECTS
    //7th SEM
    Subject(291, "Green Building Technologies",branchToSem: {'CSE':['7'],'IT':['7'],'ECE':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    Subject(292, "Fundamentals of IoT",branchToSem: {'CSE':['7'],'IT':['7'],'ECE':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    Subject(293, "Non-Conventional Energy Sources",branchToSem: {'CSE':['7'],'IT':['7'],'ECE':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    Subject(294, "Entrepreneurship",branchToSem: {'CSE':['7'],'IT':['7'],'ECE':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    Subject(295, "Principles of Electronic Communications",branchToSem: {'CSE':['7'],'IT':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    Subject(296, "Illumination and Electric Traction systems",branchToSem: {'CSE':['7'],'IT':['7'],'EEE':['7'],'CIVIL':['7'],'MECH':['7'],'EIE':['7'],'PE':['7']},type: SubjectType.Elective),
    
    //ECE
    Subject(297, "Mobile and Cellular Communications",branchToSem: {'ECE':['7']},type: SubjectType.Elective),
    Subject(298, "Speech Signal Processing",branchToSem: {'ECE':['7']},type: SubjectType.Elective),
    Subject(299, "Digital Signal Processor Architectures",branchToSem: {'ECE':['7']},type: SubjectType.Elective),
    
    //EEE
    Subject(300, "Digital Signal Processor Architectures",branchToSem: {'ECE':['7']},type: SubjectType.Elective),
    ...
    //*VERIFIED
    Subject(152, "DISTRIBUTED SYSTEMS",branchToSem: {"IT":["6","8"],"CSE":['7'],},type: SubjectType.Elective),
    //*VERIFIED
    ...
    //* VERIFIED 
    Subject(176, "CONSTRUCTION MANAGEMENT AND TECHNOLOGY",branchToSem: {"CIVIL":["8"]},type: SubjectType.Elective),
    //! DELETE [USELESS] 
